	...
	<script type="text/javascript">
		$(function () {
			...
			$("button.addToCart").click(function () {
				...
				$.getJSON("http://localhost:8088/mall_02/CartServlet","action=ajaxAddItem&id="+bookId,function (data) {
                    $("#cartTotalCount").text("您的购物车中有" + data.totalCount + "件商品");
                    $("#cartLastName").text("您刚刚将"+data.lastName+"添加入购物车");
				})
				//location.href = "http://localhost:8088/mall_02/CartServlet?action=addItem&id="+bookId;
			});
		});
	</script>
</head>
